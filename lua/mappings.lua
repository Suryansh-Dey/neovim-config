...
map("n", "<leader>k", "<cmd>cprev<CR>", { desc = "Move to next in quick fix list", silent = true })
map("n", "<leader>j", "<cmd>cnext<CR>", { desc = "Move to next in quick fix list", silent = true })
map("n", "<leader>K", "<cmd>lprev<CR>", { desc = "Move to next in location list", silent = true })
map("n", "<leader>J", "<cmd>lnext<CR>", { desc = "Move to next in location list", silent = true })
